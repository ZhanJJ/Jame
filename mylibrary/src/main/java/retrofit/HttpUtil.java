...
import retrofit.converter.StringConverterFactory;
...
import retrofit.interfaces.Progress;
import retrofit.interfaces.Success;
import retrofit.utils.OkHttpProvider;
...
public class HttpUtil {
    ...
    public static class SingletonBuilder {
        ...
        public HttpUtil build() {
            ...
            if (client == null) {
                client = OkHttpProvider.okHttpClient(appliactionContext, baseUrl, servers);
            }
...
//            };
        ...
        public void download() {
            ...
            this.headers.put(Constant.DOWNLOAD, Constant.DOWNLOAD);
            this.headers.put(Constant.DOWNLOAD_URL, this.url);
            final Call call = mService.download(checkHeaders(headers), url, checkParams(params));
            putCall(tag, url, call);
