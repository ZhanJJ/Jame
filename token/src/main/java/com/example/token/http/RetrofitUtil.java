...
package com.example.token.http;
...
import com.example.token.MainActivity;
import com.example.token.base.BaseApplication;
import com.example.token.http.converter.GsonConverterFactory;
import com.example.token.http.proxy.ProxyHandler;
